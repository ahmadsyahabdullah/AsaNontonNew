...
[![License](https://img.shields.io/github/license/Sansekai/ASANONTON DRAMA CHINA - AHMAD SYAH ABDULLAH)](https://github.com/Sansekai/ASANONTON DRAMA CHINA - AHMAD SYAH ABDULLAH/blob/main/LICENSE)
[![Repository](https://img.shields.io/badge/GitHub-Repository-blue?logo=github)](https://github.com/Sansekai/ASANONTON DRAMA CHINA - AHMAD SYAH ABDULLAH)

![Preview](public/preview.png)

ASANONTON DRAMA CHINA - AHMAD SYAH ABDULLAH adalah platform streaming drama pendek (vertical drama) modern yang menampilkan konten dari bebebrapa platform populer. Dibangun dengan teknologi web terkini untuk performa maksimal dan pengalaman pengguna yang premium.
...
2.  Clone repository ini ke komputer Anda:
    ```bash
    git clone https://github.com/Sansekai/ASANONTON DRAMA CHINA - AHMAD SYAH ABDULLAH.git
    ```
3.  Masuk ke folder project:
    ```bash
    cd ASANONTON DRAMA CHINA - AHMAD SYAH ABDULLAH
    ```
